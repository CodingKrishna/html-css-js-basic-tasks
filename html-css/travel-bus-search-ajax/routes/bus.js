var cities1=['amalapuram','anakapalli','bhimavaram','chitoor','chiala','guntur','hyderabad','hubli',
'jaggarddygudem',
'jagityala','jatcharla','jaggayapeta','kakinada','karnool','kamareddy','kandhukuru',
'khammam','medek','manchiryal','madanapalli','niyal','nandigama','nellore','adilabad',
'adoni','kadapa','srikakulam','badrachalam','vishakapatnam','vizag','vijayawada','tuni','kavali','ongole',
'eluru','siddipet','godavarigani','sirpurkagaznagar','asifabad','zahirabad','kazipet','karnool'];


var cities=["Mumbai","Delhi","Bengaluru","Ahmedabad","Gandhinagar","Hyderabad","Chennai",  
"Kolkata",  "Pune","Jaipur","Surat","Lucknow",  "Kanpur",  "Nagpur","Patna","Indore",  
"Thane","Bhopal",  "Visakhapatnam",  "Vadodara","Firozabad",  "Ludhiana","Rajkot","Agra",  
"Siliguri",  "Nashik","Faridabad","Patiala","Meerut",  "Kalyan-Dombivali","Vasai-Virar","Varanasi",
  "Srinagar",  "Dhanbad","Jodhpur","Amritsar","Raipur","Allahabad",  "Coimbatore",  "Jabalpur",
    "Gwalior",  "Vijayawada",  "Madurai",  "Guwahati","Chandigarh","Hubli-Dharwad","Amroha",
...
exports.busList= function(req,resp){
   ...
   for(var i=0;i<cities.length;i++)
   {
       ...
       var lower=cities[i].toLocaleLowerCase();    

            if(from === lower.slice(0,size) )
            {
                  data.push(lower);
            }
            // console.log(data)
   }
  // var data2 = cities.filter((city)=>{
  //   return city.includes(from);
  // })
